...
Route::get('/a-shattered-sleep',[FrontController::class, 'aShatteredSleep'])->name('front.aShatteredSleep');
Route::get('/about',[FrontController::class, 'about'])->name('front.about');
Route::get('/books',[FrontController::class, 'books'])->name('front.books');
